import { Base, ISurveyElement, ItemValue, JsonObjectProperty, SurveyElement, SurveyModel, PageModel, PanelModel } from "survey-core";
...
export declare class SurveyHelper {
    ...
    static isPanelDynamic(element: any): boolean;
}
