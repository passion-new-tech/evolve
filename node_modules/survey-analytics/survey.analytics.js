...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MatrixDropdownGrouped: () => (/* binding */ MatrixDropdownGrouped)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./src/utils/helpers.ts");
...
var MatrixDropdownGrouped = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MatrixDropdownGrouped.prototype, "dataNames", {
        get: function () {
    ...
    MatrixDropdownGrouped.prototype.getCalculatedValuesCore = function () {
        var values = this.getValues();
        var series = this.getSeriesValues();
...
var PlotlySetup = /** @class */ (function () {
    ...
    PlotlySetup.setup = function (charType, model, answersData) {
    ...
    PlotlySetup.setupBar = function (model, answersData) {
        var lineHeight = 30;
        var topMargin = 30;
        var bottomMargin = 30;
        var datasets = answersData.datasets, labels = answersData.labels, colors = answersData.colors, texts = answersData.texts, seriesLabels = answersData.seriesLabels;
    ...
    PlotlySetup.setupScatter = function (model, answersData) {
        var lineHeight = 30;
        var topMargin = 30;
        var bottomMargin = 30;
        var datasets = answersData.datasets, labels = answersData.labels, colors = answersData.colors, texts = answersData.texts, seriesLabels = answersData.seriesLabels;
