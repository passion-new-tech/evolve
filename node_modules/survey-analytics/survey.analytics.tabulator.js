...
})(this, (__WEBPACK_EXTERNAL_MODULE_survey_core__, __WEBPACK_EXTERNAL_MODULE_tabulator_tables__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DocumentHelper: () => (/* reexport safe */ _utils_index__WEBPACK_IMPORTED_MODULE_21__.DocumentHelper),
/* harmony export */   Table: () => (/* reexport safe */ _tables_table__WEBPACK_IMPORTED_MODULE_18__.Table),
/* harmony export */   TableEvent: () => (/* reexport safe */ _tables_table__WEBPACK_IMPORTED_MODULE_18__.TableEvent),
/* harmony export */   TableExtensions: () => (/* reexport safe */ _tables_extensions_tableextensions__WEBPACK_IMPORTED_MODULE_20__.TableExtensions),
/* harmony export */   TableRow: () => (/* reexport safe */ _tables_table__WEBPACK_IMPORTED_MODULE_18__.TableRow),
/* harmony export */   Tabulator: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_19__.Tabulator),
/* harmony export */   TabulatorRow: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_19__.TabulatorRow),
/* harmony export */   defaultDownloadOptions: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_19__.defaultDownloadOptions),
/* harmony export */   defaultOptions: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_19__.defaultOptions),
...
/* harmony import */ var _tables_extensions_rowextensions__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../tables/extensions/rowextensions */ "./src/tables/extensions/rowextensions.ts");
/* harmony import */ var _tables_extensions_headerextensions__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../tables/extensions/headerextensions */ "./src/tables/extensions/headerextensions.ts");
/* harmony import */ var _tables_extensions_columnextensions__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../tables/extensions/columnextensions */ "./src/tables/extensions/columnextensions.ts");
/* harmony import */ var _tables_extensions_detailsextensions__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../tables/extensions/detailsextensions */ "./src/tables/extensions/detailsextensions.ts");
/* harmony import */ var _tables_table__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../tables/table */ "./src/tables/table.ts");
/* harmony import */ var _tables_tabulator__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../tables/tabulator */ "./src/tables/tabulator.ts");
/* harmony import */ var _tables_extensions_tableextensions__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../tables/extensions/tableextensions */ "./src/tables/extensions/tableextensions.ts");
...
/***/ "./src/tables/custom_jspdf_font.ts":
/*!*****************************************!*\
  !*** ./src/tables/custom_jspdf_font.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var TableExtensions = /** @class */ (function () {
    ...
    TableExtensions.getExtensions = function (location) {
        if (!this.extensions[location])
            return [];
...
/* harmony export */   TabulatorRow: () => (/* binding */ TabulatorRow),
/* harmony export */   defaultDownloadOptions: () => (/* binding */ defaultDownloadOptions),
...
if (!!document) {
    ...
    templateHolder.innerHTML = _svgbundle__WEBPACK_IMPORTED_MODULE_6__.svgTemplate;
...
var defaultDownloadOptions = {
    ...
    pdf: {
        ...
        autoTable: function (doc) {
            doc.addFileToVFS("custom_helvetica.ttf", _custom_jspdf_font__WEBPACK_IMPORTED_MODULE_5__.ARIAL_FONT);
...
var escapeCellFormula = function (field) {
    var formulaPrefix = ["=", "+", "-", "@", String.fromCharCode(0x09), String.fromCharCode(0x0d)];
    if (formulaPrefix.some(function (prefix) { return field.startsWith(prefix); })) {
        return "'" + field;
    }
    else {
        return field;
...
var Tabulator = /** @class */ (function (_super) {
    ...
    function Tabulator(survey, data, options, _columnsData) {
        ...
        _this.accessorDownload = function (cellData, rowData, reason, _, columnComponent, rowComponent) {
            if (Array.isArray(_this.data)) {
                var columnDefinition = columnComponent.getDefinition();
                var questionName_1 = columnDefinition.field;
                var column = _this.columns.filter(function (col) { return col.name === questionName_1; })[0];
                if (!!column && rowComponent) {
                    ...
                    if (column.dataType === _config__WEBPACK_IMPORTED_MODULE_2__.ColumnDataType.FileLink && Array.isArray(dataCell)) {
    ...
    Tabulator.initTabulatorConstructor = function (tabulatorTablesConstructor) {
    ...
    Tabulator.prototype.render = function (targetNode) {
        ...
        var header = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div", "sa-tabulator__header");
        var paginationElement = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div", "sa-tabulator__pagination-container");
        this.tableContainer = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div");
            ...
            config.ajaxURL = "function",
                config.ajaxRequestFunc = function (url, config, params) {
                    return new Promise(function (resolve, reject) {
                        var _a, _b;
                        var dataLoadingCallback = function (loadedData) {
                            if (!loadedData.error && Array.isArray(loadedData.data)) {
                                resolve({ data: loadedData.data.map(function (item) { return _this.processLoadedDataItem(item); }), last_page: Math.ceil(loadedData.totalCount / params.size) });
                            }
                            else {
                                reject();
                            }
                        };
                        var dataLoadingPromise = _this.data({
                            offset: (params.page - 1) * params.size,
                            limit: params.size,
                            filter: (_a = _this.tabulatorTables) === null || _a === void 0 ? void 0 : _a.getFilters(false),
                            sort: (_b = _this.tabulatorTables) === null || _b === void 0 ? void 0 : _b.getSorters().map(function (s) { return ({ field: s.field, direction: s.dir }); }),
        ...
        var extensionsContainer = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div", "sa-table__header-extensions");
    ...
    Tabulator.prototype.createDownloadsBar = function () {
        ...
        var createDownloadButton = function (type, caption) {
            var btn = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("button", "sa-table__btn sa-table__btn--small sa-table__btn--gray", {
                innerText: caption,
                onclick: function () {
                    _this.download(type);
                },
        ...
        var container = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div", "sa-tabulator__downloads-bar");
        this._options.downloadButtons.forEach(function (type) {
            container.appendChild(createDownloadButton(type, _localizationManager__WEBPACK_IMPORTED_MODULE_4__.localization.getString("".concat(type, "DownloadCaption"))));
        });
        return container;
    };
    Tabulator.prototype.getTitleFormatter = function (cell, formatterParams, onRendered, columnName) {
        var _this = this;
        var container = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div");
        var title = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("span", "", {
    ...
    Tabulator.prototype.getHeaderActions = function (columnName) {
        var container = _utils__WEBPACK_IMPORTED_MODULE_3__.DocumentHelper.createElement("div", "sa-table__action-container");
    ...
    Tabulator.prototype.getColumns = function () {
        ...
        var columns = this.columns.map(function (column, index) {
            ...
            return {
                ...
                headerSort: false,
                minWidth: _this._options.columnMinWidth,
        ...
        columns.unshift({
            ...
            tooltip: function (_, cell) {
                return _localizationManager__WEBPACK_IMPORTED_MODULE_4__.localization.getString("actionsColumn");
            }
        });
        // }
        return columns;
    ...
    Tabulator.prototype.getPageNumber = function () {
        ...
        var pageNumber = this.tabulatorTables.getPage();
    ...
    Tabulator.prototype.getDownloadOptions = function (type) {
        var options = Object.assign({}, this._options.downloadOptions[type] || defaultOptions.downloadOptions[type]);
        var onDownloadCallback = this._options.onDownloadCallbacks[type];
    ...
    Tabulator.prototype.download = function (type) {
        ...
        this.tabulatorTables.download(type, "".concat(this._options.downloadOptions.fileName, ".").concat(type), this.getDownloadOptions(type));
    };
    Tabulator.prototype.layout = function (hard) {
        if (hard === void 0) { hard = false; }
        this.tabulatorTables.redraw(hard);
    };
    Tabulator.prototype.processLoadedDataItem = function (item) {
        var dataItem = _super.prototype.processLoadedDataItem.call(this, item);
...
var TabulatorRow = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(TabulatorRow, _super);
...
/* harmony export */   TableRow: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.TableRow),
/* harmony export */   Tabulator: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.Tabulator),
/* harmony export */   TabulatorRow: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.TabulatorRow),
/* harmony export */   defaultDownloadOptions: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.defaultDownloadOptions),
/* harmony export */   defaultOptions: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.defaultOptions),
/* harmony export */   localization: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.localization),
/* harmony export */   surveyStrings: () => (/* reexport safe */ _tabulator__WEBPACK_IMPORTED_MODULE_0__.surveyStrings)
/* harmony export */ });
/* harmony import */ var _tabulator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabulator */ "./src/entries/tabulator.ts");
/* harmony import */ var tabulator_tables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tabulator-tables */ "tabulator-tables");
...
_tabulator__WEBPACK_IMPORTED_MODULE_0__.Tabulator.initTabulatorConstructor((tabulator_tables__WEBPACK_IMPORTED_MODULE_1___default()));
